...
func IsMediumUrl(str string) bool {
	...
	validHosts := map[string]bool{
		...
		"writingcooperative.com":     true,
		"javascript.plainenglish.io": true,
		"code.likeagirl.io":          true,
		"blog.bitsrc.io":             true,
		"medium.muz.li":              true,
		"pub.towardsai.net":          true,
		"ai.plainenglish.io":         true,
		"proandroiddev.com":          true,
		"itnext.io":                  true,
		"infosecwriteups.com":        true,
		"byrslf.co":                  true,
		"ainyf.com":                  true,
		"muddyum.net":                true,
		"thebelladonnacomedy.com":    true,
		"baos.pub":                   true,
		"hinged.press":               true,
	}
